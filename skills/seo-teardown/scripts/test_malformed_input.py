#!/usr/bin/env python3
"""Table-driven wrong-type regression tests for seo-teardown.
...
from validate_seo_teardown import validate
...
KNOWN_UNGUARDED: frozenset[str] = frozenset([
    "validate_seo_teardown.py:1010",
    "validate_seo_teardown.py:1035",
    "validate_seo_teardown.py:1174",
    "validate_seo_teardown.py:1223",
    "validate_seo_teardown.py:1321",
    "validate_seo_teardown.py:1335",
    "validate_seo_teardown.py:1414",
    "validate_seo_teardown.py:1432",
    "validate_seo_teardown.py:738"
])
...
class MalformedInputTests(unittest.TestCase):
    ...
    CANONICAL = ('findings.json', 'coverage.json')

    def _fixture(self) -> Path:
        from test_validator import write_fixture
        root = Path(tempfile.mkdtemp()) / "seo-teardown"
        write_fixture(root)
